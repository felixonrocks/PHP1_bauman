<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white overflow-hidden shadow rounded-lg min-h-full">
            ...
            <h3 class=" h-20 pt-8 mx-8 font-bold"><a href="<?php echo e(Route('trends.index')); ?>">Tendences</a><span class="text-[#94ae0e]"> > </span> <?php echo e($post['name']); ?></h3>
            ...
            <div class=" text-sm mx-8 "><?php echo e($post['content']); ?></div>
                <div class="grid grid-cols-4 mt-4 ml-4 pb-4">
                    <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <img class="w-40 h-40 m-4 shadow-xl rounded" src=<?php echo e(asset("storage/$url")); ?>>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u901121957/domains/idistance.school/lara/app/resources/views/layouts/default/item.blade.php ENDPATH**/ ?>