...
<body>
  ...
  <nav class=" flex justify-items-stretch h-10 w-full ml-0 pb-2 mt-0 md:pb-4 lg:pb-4 md:hidden lg:hidden md:h-30 lg:h-30 bg-grey-500">
                ...
                <div class=" inline-flex justify-self-end ml-16 mr-0 pr-0 end md:hidden lg:hidden rounded-xl">
                    <?php echo $__env->make('components.searchwindow', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
...
<footer class="mx-auto w-full" id="footer">
    ...
    <div class="ml-6 pb-6"><a href="<?php echo e(Route('/')); ?>">
        © 2021 Prontolux sa</a>
    </div>
</footer>
...
<?php /**PATH /var/www/vhosts/prontolux.ch/httpdocs/lara/app/resources/views/welcome.blade.php ENDPATH**/ ?>