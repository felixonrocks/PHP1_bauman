                ...
                <?php $__currentLoopData = $header; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title=>$link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <main class="mt-8 bg-white overflow-hidden shadow rounded-lg min-h-fit">
                        ...
                        <div class="border-b pb-8">
                            ...
                            <img src="/storage/<?php echo e($technologie['image']); ?>" class="pl-1 m-auto h-45 md:h-80">
                            <div class="text-sm text-gray-600 m-2 md:px-8 pt-12 pb-2 md:pb-4 md:w-3/4 m-auto"><?php echo $technologie['content']; ?></div>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u901121957/domains/idistance.school/lara/app/resources/views/layouts/default/technologies.blade.php ENDPATH**/ ?>