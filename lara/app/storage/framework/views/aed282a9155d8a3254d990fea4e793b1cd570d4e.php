...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="lara.localhost/css/app.css">
    <style>
    ...
    <style>
        ...
        .announcement-bar{background-color: #94ae0e; height: 44px; color: white; font-weight: 500;    text-align: center;
            position: relative; font-size:17px; display: block; padding: 10px;}
        .site-header{font-size: 1em;
            text-transform: uppercase; letter-spacing: .1em;    font-weight: 600;line-height: 1.2;}
        .grid{align-items: center; font-weight: 400; }
        .menu-item:active{border-bottom: 2px solid #94ae0e;  }
        .menu-item{font-family: "Work Sans",sans-serif; font-weight: 400; font-size: 16px; line-height: 1.5;}
        ...
        .bg-accent{background-color: #94ae0e;}
...
<header id="header">
    ...
    <nav class="grid grid-cols-5 gap-2 gap-x-2 gap-y-3 items-justify">

        <div class="site-header col-start-1 col-span-1 pl-4 pr-4">

            <div class="flex flex-row justify-start w-22 ml-0 logo">

                
                <label id="hamburger" for="hamburger-input" >
                ...
                <a href="/" class="site-header" title="home">Prontolux</a>
            </div>
        </div>
        <div class="col-span-3 grid1 grid-cols-3 text-sm pb-1">
            
            <div class="px-1 menu-item font-normal text-center my-auto ">
                <a href="/products/">Produits</a>
            </div>

            
            <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id=>$cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="px-1 menu-item text-center  my-auto ">
                        <a href="<?php echo e(Route('categories.show', $id)); ?>" class=""><?php echo e($cat); ?></a>
                    </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

        </div>
        <div class="col-span-1 gap-4 grid1 justify-end mr-5">

            
            <div class="grid1">
                <input class=" text-xs"  type="text" placeholder=" search..">
            
                <a href="#" title="cart"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="grey" class="bi bi-cart2 pl-2 pb-2 " viewBox="0 0 16 16">
    ...
    <ul class="nav-menu text-xs font-semibold">
        <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link=>$section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="py-1 pl-2" id="nav"><a href="/<?php echo e($link); ?>"><?php echo e($section); ?></a></li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </ul>
    ...
    <div class="">
        <?php if(Route::has('login')): ?>
            <div class="hidden fixed top-2 right-0 px-5 py-7 sm:block">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/dashboard')); ?>" class="text-sm text-gray-700 dark:text-gray-500  underline ">Dashboard</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-700 dark:text-gray-500 font-bold py-4">Log in</a>

                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="ml-4 text-sm text-gray-700 dark:text-gray-500 font-bold py-4">Register</a>
                    <?php endif; ?>
                <?php endif; ?>
                <select class="ml-2">
                    <option>fr</option>
...
<footer class="mx-auto w-full" id="footer">
    ...
    <div class="grid grid-cols-4 text-sm font-bold h-60 w-3/4 mx-auto">
        <?php $__currentLoopData = $footer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="grid-col-1 mx-auto">
                <h6 class="mx-auto text-center"><a href="./pages/<?php echo e($title['link']); ?>"><?php echo e($title['name']); ?></a></h6>
                <div class="text-xs mx-auto font-normal text-center"><?php echo e($title['description']); ?></div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
    ...
    <nav class="grid footer grid-cols-4 h-20 ">
        ...
        <div class="grid-col-1 grid1 justify-end mr-4">
            ...
            <div class="menu-item mx-1">Mastercard</div>
        </div>
    </nav>
...
<?php /**PATH /home/u901121957/domains/idistance.school/laravel/resources/views/welcome.blade.php ENDPATH**/ ?>