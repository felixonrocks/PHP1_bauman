                ...
                <section class="flex inline-flex pr-4">
                    <div class="w-2/3 px-8">
                        ...
                        <form class="w-2/3 m-auto" action="<?php echo e(route('contact.store')); ?>" method="POST">
                            ...
                            <button class="bg-accent w-full h-8 border-none rounded shadow-lg m-2 mb-0 text-sm text-white" type="submit" name="send" value="Submit" >Envoyer</button>
                        </form>
                    </div>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u901121957/domains/idistance.school/lara/app/resources/views/layouts/default/contactus.blade.php ENDPATH**/ ?>