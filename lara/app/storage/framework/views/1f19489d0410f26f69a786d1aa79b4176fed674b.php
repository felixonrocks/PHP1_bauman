    ...
    <section class="pb-4">
        ...
        <div class=" font-semibold flex mx-8 my-4 ">
            ...
            <div class=" ml-auto flex-1 ml-4 ">
                <a href="<?php echo e(Route('products.create')); ?>" class="btn-large hover:antialiased pt-1.5" dusk="create-button">
                    Creer Produit
                </a>
            </div>
        </div>
                        ...
                        <tr dusk="772-row">
                            ...
                            <td>
                                <p resource="[object Object]" class="text-center">
                                    <img src="/storage/<?php echo e($item->image); ?>" class="align-bottom w-16 h-16 rounded" style="object-fit: cover;">
                                </p>
                            </td>
                            <td>
                                <div class="text-left px-4" resource="[object Object]">
                                    <a href="<?php echo e(Route('products.show', $item['id'])); ?>" class="whitespace-no-wrap no-underline dim text-secondary font-bold">
                            ...
                            <td>
                                <div class="text-left text-left" resource="[object Object]">
                                    <span class="whitespace-no-wrap text-accent">
                                        <?php echo e(substr($item->description, 0, 30)); ?>
                            ...
                            <td class="td-fit text-right px-4 align-middle">
                                <div class="inline-flex items-center">
                                    <span class="inline-flex">
                                        <a href="<?php echo e(Route('products.show', $item['id'])); ?>" class="cursor-pointer text-70 hover:text-primary mr-3 inline-flex items-center has-tooltip bg-[#e3e7eb]" data-testid="products-items-0-view-button" dusk="772-view-button" data-original-title="null">
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u901121957/domains/idistance.school/lara/app/resources/views/admin/pages/products.blade.php ENDPATH**/ ?>