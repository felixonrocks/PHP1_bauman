...
<body>
    ...
    <div class="w-60 h-10 ml-auto">
        <?php if(Route::has('login')): ?>
            <div class="hidden px-5 pt-1.5 sm:block flex flex-row max-w-30">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-700  font-bold pt-4 justify-self-end">Log in</a>

                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="ml-4 text-sm text-gray-700 font-bold pt-4">Register</a>
                    <?php endif; ?>
                <?php endif; ?>
                <select class="ml-2">
                    <option>fr</option>
  ...
  <nav class="bg-grey-500 flex justify-items-stretch h-30 w-full ml-0  bg-grey-100 pb-2 md:pb-4 lg:pb-4 md:hidden lg:hidden">
                ...
                <div class=" inline-flex justify-self-end ml-24 end md:hidden lg:hidden">
                <form action="/searchall" method="GET" role="search">
                    <input class=" text-xs"  type="text" placeholder=" search.." name="q"
                </form>
            </div>
    ...
    <nav class="grid grid-cols-5 gap-2 gap-x-2 items-justify h-fit md:py-4 lg:py-4">
        ...
        <div class="col-span-1 gap-4 grid1 justify-end mr-5 flex inline-flex">

            
            <div class="grid1 inline-flex hidden md:block lg:block">
                <form name="search" method="POST" action="search.php" class="rounded ml-2">
                    <input class=" text-xs"   type="search" name="query" placeholder=" search..">
                    <button type="submit"></button>
                </form>
            
                <a href="#" title="cart"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="grey" class="bi bi-cart2 pl-2 pb-2 inline-flex " viewBox="0 0 16 16">
    ...
    <ul class="nav-menu text-xs font-semibold">
        <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link=>$name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="py-1 pl-2" id="nav"><a href="/<?php echo e($link); ?>"><?php echo e($name); ?></a></li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </ul>
    ...
    <div class="grid grid-cols-4 text-sm font-bold h-60 w-full md:w-3/4 lg:w-3/4 mx-auto">
        <?php $__currentLoopData = $footer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="grid-col-1 mx-auto px-3">
                <h6 class="md:mx-auto lg:m-auto text-center"><a href="<?php echo e(URL::to('/')); ?>/<?php echo e($title['link']); ?>"><?php echo e($title['name']); ?></a></h6>
                <div class="text-xs md:mx-auto lg:m-auto font-normal text-center hidden md:block lg:block"><?php echo e($title['description']); ?></div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
<?php /**PATH /home/u901121957/domains/idistance.school/lara/app/resources/views/welcome.blade.php ENDPATH**/ ?>