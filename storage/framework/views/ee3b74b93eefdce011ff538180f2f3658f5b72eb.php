                ...
                <div class="flex-col items-center py-2">
                    <?php $__currentLoopData = $icons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex ">
                            ...
                            <img src="/storage/<?php echo e($icon['icon_url']); ?>" class="w-8 h-8 rounded-md  my-1 p-1 cursor-pointer inline-flex ">
                            <div class="inline-flex text-center  my-1 p-1 px-2 w-60 text-primary"><?php echo e($icon['icon_info']); ?></div>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /applications/XAMPP/xamppfiles/htdocs/lara/app/resources/views/admin/pages/products/new.blade.php ENDPATH**/ ?>