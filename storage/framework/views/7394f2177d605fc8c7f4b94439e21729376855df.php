<?php $__env->startSection('admin.dashboard'); ?>
    ...
    <div class="text-gray-700">
        <div class="flex flex-wrap-mx-4">
            <div class="px-3 mb-6 w-4/5">
                <div class="flex justify-center items-centers" lens="">
                    <div class="w-4/5 ">
                        <h1 class="flex mb-3 text-90 font-normal text-2xl">Get Started</h1>
                        <p class="text-90 leading-tight mb-8 p-4 ">
                                    ...
                                    <td class="align-top w-1/2 border-r border-b border-50">
                                        <a href="https://nova.laravel.com/docs/3.0/filters/defining-filters.html"
                                           class="no-underline dim flex p-6">
                                            ...
                                            <div><h3 class="mb-3 text-90 uppercase tracking-wide font-bold text-sm">
                                                    Filters</h3>
                                                <p class="text-90 leading-normal">
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /applications/XAMPP/xamppfiles/htdocs/lara/app/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>