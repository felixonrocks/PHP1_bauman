        ...
        <div>
            <div class="flex items-center mb-3 mx-12 text-primary">
                ...
                <div class="ml-3 flex items-center">
                    ...
                    <a href="/admins/products/<?php echo e($product['id']); ?>/edit"
            ...
            <div class="card mb-6 py-3 px-6 bg-white mx-12 rounded-xl text-primary">
                    ...
                    <div class="w-3/4 py-4 break-words">
                        <div>
                            <div data-v-1c591609=""
                                ...
                                <img src="/storage/<?php echo e($product['image']); ?>" class="block w-full" draggable="false">
                            </div> <!----> <!---->
                ...
                <div class="flex border-b border-40 -mx-6 px-6">
                    ...
                    <div class="w-3/4 py-4 break-words"><p class="text-90 text-accent">
                            <?php echo e($product['categorie_id']); ?>
                    ...
                    <div class="w-3/4 pt-4 break-words pb-14">
                        <div class="">
                            <div data-v-1c591609=""
                                 ...
                                 style="max-width: 320px;">
                                <img
                                    src="/storage/img/products/<?php echo e($product['id']); ?>/"
                ...
                <div class="flex border-40 -mx-6 px-6 remove-bottom-border">
                    ...
                    <div class="w-3/4 py-4 break-words">
                        ...
                        <?php echo e(substr($product['created_at'], 0, 10)); ?>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /applications/XAMPP/xamppfiles/htdocs/lara/app/resources/views/admin/pages/products/card.blade.php ENDPATH**/ ?>