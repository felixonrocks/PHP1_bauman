<?php $__env->startSection('content'); ?>
                ...
                <div class="mt-0 bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
                            ...
                            <div class="px-4">
                                <div class=" w-20 align-middle">
                                    ...
                                    <div class=" text-xs leading-3 font-semibold h-8 pt-3 text-center">
                                        <a href="/select/<?php echo e($subcat['id']); ?>" class=" text-gray-600 dark:text-white border-b-emerald-400"><?php echo e($subcat['cat_name']); ?></a>
                                    </div>
                                </div>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /applications/XAMPP/xamppfiles/htdocs/lara/app/resources/views/layouts/default/catsubmenu.blade.php ENDPATH**/ ?>